...
bg = display.newImageRect('env1.jpg',w ,h)
        ...
        group:insert(bg)
--]]
  d1 = display.newImageRect('drake1.jpg',w ,h)
        d1.alpha=.4
        d1.x = w - w/2
        d1.y = h - h/2
        group:insert (d1)    

level =   display.newText( "37/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = " What did Obi-Wan mean when he said to Vader 'You can't win, Vader. If you strike me down, I shall become more powerful than you can possibly imagine'?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "He Would Kill Him In His Sleep", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "His Ghost Would Haunt Him", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "He Would Be More Powerful In Death", answer3.x, answer3.y, "marker felt", 46)
...
answer4Text=display.newText( "He Could Advise Luke Anywhere", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "opinions matter...",  w/2, h/4+100, "marker felt", 40 )
