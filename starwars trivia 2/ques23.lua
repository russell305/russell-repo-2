...
level =   display.newText( "23/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Whom was Han Solo in debt to?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Jabba The Hutt", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Palpatine", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Vader", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Snaggletooth", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "big and fat...",  w/2, h/4+100, "marker felt", 40 )
