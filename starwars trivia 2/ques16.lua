...
level =   display.newText( "16/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What was the name of the planet that the clones were made on?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Dagobah", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Kamino", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Endor", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Naboo", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "k...",  w/2, h/4+100, "marker felt", 40 )
