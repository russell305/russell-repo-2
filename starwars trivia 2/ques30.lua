...
level =   display.newText( "30/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What is the name of the planet that Obi-Wan wants to take Luke to?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Endor", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Dagobah", answer2.x, answer2.y, "marker felt", 50 )
...
answer4Text=display.newText( "Alderaan", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "a...",  w/2, h/4+60, "marker felt", 40 )
