...
level =   display.newText( "27/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Why was Lando afraid of the Empire?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "They Held His Family Captive", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "He Owed Them A Favor", answer2.x, answer2.y, "marker felt", 50)
...
answer3Text=display.newText( "They Could Shut Down His Mining Operation", answer3.x, answer3.y, "marker felt", 36 )
...
answer4Text=display.newText( "He Wasn't", answer4.x, answer4.y, "marker felt", 50)
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "iron ore...",  w/2, h/4+100, "marker felt", 40 )
