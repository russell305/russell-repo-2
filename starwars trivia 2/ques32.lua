...
level =   display.newText( "32/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What kept Cloud City suspended over Bespin?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Unipod Surrounded By Reactor", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Reverse Gravity Reactors", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Zero Gravity Jets", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Propulsion Vortex System", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "one...",  w/2, h/4+100, "marker felt", 40 )
