...
level =   display.newText( "49/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "How old is Yoda when he dies?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "800", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "700", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "1100", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "900", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "9...",  w/2, h/4+100, "marker felt", 40 )
