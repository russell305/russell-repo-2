...
level =   display.newText( "2/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Which Star Wars had Ewoks?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Revenge Of The Sith", answer1.x, answer1.y, "marker felt", 50 )
...
answer3Text=display.newText( "Return Of The Jedi", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "The Empire Strikes Back", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "jedi master...",  w/2, h/4+100, "marker felt", 40 )
