...
bg = display.newImageRect('env1.jpg',w ,h)
  ...
  d1 = display.newImageRect('drake3.jpg',w ,h)
        d1.alpha=.4
        d1.x = w - w/2
        d1.y = h - h/2
        group:insert (d1)    

level =   display.newText( "15/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Why did Uncle Owen insist that Luke postpone his application to the Academy?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "He Needed More Training", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "He Needed To Study More", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "He Was Needed To Defend Their Home From Sandpeople", answer3.x, answer3.y, "marker felt", 30 )
...
answer4Text=display.newText( "He Was Needed On The Farm For Another Season", answer4.x, answer4.y, "marker felt", 33 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "plant some seeds....",  w/2, h/4+100, "marker felt", 40 )
