...
level =   display.newText( "26/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What creatures formed the work force in Cloud City?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Ugnaughts", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Ubebas", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Unarks", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Urusais", answer4.x, answer4.y, "marker felt", 50)
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "ug...",  w/2, h/4+100, "marker felt", 40 )
