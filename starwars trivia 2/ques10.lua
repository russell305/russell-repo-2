...
level =   display.newText( "10/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What is the only movie that Han Solo uses a light saber?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "The Phantom Menace", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "A New Hope", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "The Empire Strikes Back", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Return Of The Jedi", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "snow...",  w/2, h/4+60, "marker felt", 40 )
