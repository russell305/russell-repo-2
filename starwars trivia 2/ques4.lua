...
level =   display.newText( "4/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Who did the bartender say the cantina on Tatooine would not serve?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Wookies", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Jedis", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Humans", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Droids", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "robots...",  w/2, h/4+100, "marker felt", 40 )
