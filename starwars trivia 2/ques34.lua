...
level =   display.newText( "34/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Whose body is crushed under the foot of an Imperial walker?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Windy", answer1.x, answer1.y, "marker felt", 50 )
...
answer3Text=display.newText( "Dack", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Ben", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "ck...",  w/2, h/4+100, "marker felt", 40 )
