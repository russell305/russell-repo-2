...
level =   display.newText( "13/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "In The Phantom Menace, who is the Droid Amidala thanks for his bravery?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "C-3PO", answer1.x, answer1.y, "marker felt", 50)
...
answer2Text=display.newText( "IG-88", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "ASN-121", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "R2-D2", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "astromech droid...",  w/2, h/4+100, "marker felt", 40 )
