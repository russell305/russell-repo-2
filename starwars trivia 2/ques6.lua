...
level =   display.newText( "6/50",40,15, "marker felt", 30 )
...
answer1Text=display.newText( "Billy Dee Williams", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Harrison Ford", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "James Earl Jones", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Mark Hamill", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "indiana...",  w/2, h/4+100, "marker felt", 40 )
