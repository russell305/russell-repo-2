...
level =   display.newText( "21/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Why did Han, Luke and Chewbacca destroy all the lights and electronics attached to the wall in the detention area?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Saboutage", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Cover There Escape", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Attack The Stormtroopers", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Destroy Their System", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "run away...",  w/2, h/4+100, "marker felt", 40 )
