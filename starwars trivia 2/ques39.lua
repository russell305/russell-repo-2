...
level =   display.newText( "39/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Why is the Emperor so pleased to see Luke defeat Vader?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "He Expects Luke To Become His New Apprentice", answer1.x, answer1.y, "marker felt", 35 )
...
answer2Text=display.newText( "He Looks Forward To Killing Luke Himself", answer2.x, answer2.y, "marker felt", 35 )
...
answer3Text=display.newText( "He Enjoys A Good Lightsaber Duel", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "He Always Hated Vader", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "student...",  w/2, h/4+100, "marker felt", 40 )
