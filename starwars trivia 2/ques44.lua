...
level =   display.newText( "44/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What did Darth Vader do to Ben's cloak after he struck him down?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Burned It", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Tapped With Foot", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Lifted With Lightsaber", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Threw Down Shaft", answer4.x, answer4.y, "marker felt", 50)
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "twinkletoes...",  w/2, h/4+100, "marker felt", 40 )
