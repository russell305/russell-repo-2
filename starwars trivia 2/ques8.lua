...
level =   display.newText( "8/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Who was the Sith Lord that was killed in The Phantom Menace?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Darth Sidious", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Darth Vader", answer2.x, answer2.y, "marker felt", 50)
...
answer3Text=display.newText( "Darth Plagueis", answer3.x, answer3.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "m...",  w/2, h/4+100, "marker felt", 40 )
