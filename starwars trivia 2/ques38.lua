...
level =   display.newText( "38/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What object did Yoda take from Luke's supply case?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Lightsaber", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Power Lamp", answer2.x, answer2.y, "marker felt", 50)
...
answer3Text=display.newText( "A Key", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "A Journal", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "see in the dark...",  w/2, h/4+100, "marker felt", 40 )
