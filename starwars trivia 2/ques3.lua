...
level =   display.newText( "3/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "At the beginning of Star Wars what rank is Obi-Wan Kenobi?",
   -- x = question.x,
   -- y= question.y,
   x=w/2,
   y=h/6,
...
answer1Text=display.newText( "Padawan", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Jedi", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Knight", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Rook", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "nice pad...", w/2, h/4+100, "marker felt", 40 )
