...
level =   display.newText( "9/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What was the name of Princess Leia’s adoptive father?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Obi-Wan Kenobi", answer1.x, answer1.y, "marker felt", 55 )
...
answer2Text=display.newText( "Darth Vader", answer2.x, answer2.y, "marker felt", 55 )
...
answer3Text=display.newText( "Bail Organa", answer3.x, answer3.y, "marker felt", 55 )
...
answer4Text=display.newText( "Qui-Gon-Jinn", answer4.x, answer4.y, "marker felt", 55 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "organic name...",  w/2, h/4+75, "marker felt", 40 )
