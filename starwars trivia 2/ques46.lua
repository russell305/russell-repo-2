...
bg = display.newImageRect('env1.jpg',w ,h)
        ...
        group:insert(bg)
--]]
  d1 = display.newImageRect('drake2.jpg',w ,h)
        d1.alpha=.4
        d1.x = w - w/2
        d1.y = h - h/2
        group:insert (d1)    

level =   display.newText( "46/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "How do the Ewoks help the Rebels on Endor?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "By Showing Them The Back Door To The Shield Generator", answer1.x, answer1.y, "marker felt", 29 )
...
answer2Text=display.newText( "By Helping Leia Kill An Imperial Scout", answer2.x, answer2.y, "marker felt", 43 )
...
answer3Text=display.newText( "By Fighting The Imperial Troops", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "All Of The Above", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "multi-taskers...",  w/2, h/4+100, "marker felt", 40 )
