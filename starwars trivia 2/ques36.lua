...
level =   display.newText( "36/50",40,15, "marker felt", 30 )
...
answer1Text=display.newText( "Luke Skywalker", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Han Solo", answer2.x, answer2.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "girl...",  w/2, h/4+100, "marker felt", 40 )
