...
localizedPrices[3] = "$24.99";
localizedPrices[4] = "$49.99";
localizedPrices[5] = "$49.99";
localizedPrices[6] = "$49.99";
localizedPrices[7] = "$49.99";
localizedPrices[8] = "$49.99";
localizedPrices[9] = "$49.99";
localizedPrices[10] = "$49.99";
]]--
...
local productID = 
{
	"com.305games.starwars.consumable", --buyItem1
	"com.mycompanyname.myappname.myiapname", --buyItem2
	"com.mycompanyname.myappname.myiapname", --buyItem3
	"com.mycompanyname.myappname.myiapname", --buyItem4
	"com.mycompanyname.myappname.myiapname", --buyItem5
	"com.mycompanyname.myappname.myiapname", --buyItem6
	"com.mycompanyname.myappname.myiapname", --buyItem7
	"com.mycompanyname.myappname.myiapname", --buyItem8
	"com.mycompanyname.myappname.myiapname", --buyItem9
	"com.mycompanyname.myappname.myiapname", --buyItem10
