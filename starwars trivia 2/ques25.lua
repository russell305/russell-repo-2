...
level =   display.newText( "25/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Who is Count Dookualso known as?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Darth Tyranus", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Darth Maul", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Darth Sidious", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Darth Vader", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "T-Rex....",  w/2, h/4+100, "marker felt", 40 )
