...
level =   display.newText( "28/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What did Luke ask Leia to do just before they swung across the chasm on the Death Star?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Hold His Lightsaber", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Hold His Gun", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Hold On Tight", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Yell For Help", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "laser beams....",  w/2, h/4+100, "marker felt", 40 )
