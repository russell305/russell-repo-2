...
level =   display.newText( "11/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What was Luke Skywalker's original name?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Luke Starkiller", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Luke Skyslammer", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Luke Skyflyer", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Luke Starwalker", answer4.x, answer4.y, "marker felt", 50 )
