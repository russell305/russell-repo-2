...
level =   display.newText( "47/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What last name does Princess Leia get from her adopted family?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Tinabi", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Godina", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Godiva", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Organa", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "organic name...",  w/2, h/4+100, "marker felt", 40 )
