...
level =   display.newText( "35/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What would you find on the planet Hoth?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Forest", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Sand", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Ice", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Swamp", answer4.x, answer4.y, "marker felt", 50 )
