...
level =   display.newText( "43/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What did Han do to Lando when the administrator tried to excuse his treachery?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Shot Him", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Punched Him", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Scolded Him", answer3.x, answer3.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "fist...",  w/2, h/4+100, "marker felt", 40 )
