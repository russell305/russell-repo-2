...
level =   display.newText( "33/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What is the name of Lukeʼs friend from Tatooine who is killed during the attack on the Death Star?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Biggs", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Deak", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Ben", answer3.x, answer3.y, "marker felt", 50)
...
answer4Text=display.newText( "Windy", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "big guy...",  w/2, h/4+100, "marker felt", 40 )
