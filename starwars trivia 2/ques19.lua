...
level =   display.newText( "19/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "How does Obi-Wan kill general Grievous?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Throws Him Off Cliff", answer1.x, answer1.y, "marker felt", 50)
...
answer2Text=display.newText( "Decapitates Him With Lightsaber", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Poisons Him", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Shoots Him In Stomach", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "gun....",  w/2, h/4+100, "marker felt", 40 )
