...
level =   display.newText( "12/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What was Leia's starship called at the beginning of Star Wars?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Sand Runner", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Star Runner", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Blade Runner", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Blockade Runner", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "blasting blocks...",  w/2, h/4+100, "marker felt", 40 )
