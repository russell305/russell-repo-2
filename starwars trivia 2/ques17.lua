...
level =   display.newText( "17/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Who was so convinced Star Wars would be a flop, they refused to allow their name in the original credits?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "James Earl Jones", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Carrie Fisher", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Mark Hamill", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Harrison Ford", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "darth...",  w/2, h/4+100, "marker felt", 40 )
