...
level =   display.newText( "45/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Who is the jedi master who orders the clones to be created?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Yoda", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Belth Allusis", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Jorus C'baoth", answer3.x, answer3.y, "marker felt", 50)
...
answer4Text=display.newText( "Syfo Dyas", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "sd...",  w/2, h/4+100, "marker felt", 40 )
