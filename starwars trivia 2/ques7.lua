...
level =   display.newText( "7/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "Who cursed Vader to go 'Spinning off into space' in the battle of the Death Star?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Han Solo", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Luke Skywalker", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Princess Leia", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Chewbacca", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "harrison...",  w/2, h/4+100, "marker felt", 40 )
