...
level =   display.newText( "48/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What did Yoda tell Luke about adventure?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Adventure Is In The Eye Of The Beholden One", answer1.x, answer1.y, "marker felt", 36 )
...
answer2Text=display.newText( "Adventure...Excitement...A Jedi Craves Not These Things", answer2.x, answer2.y, "marker felt", 30 )
...
answer3Text=display.newText( "Adventure Ye Not Into The Dark Side", answer3.x, answer3.y, "marker felt", 36 )
...
answer4Text=display.newText( "Adventure And Glory Are Duties Of A Jedi", answer4.x, answer4.y, "marker felt", 36 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "not exciting at all...",  w/2, h/4+100, "marker felt", 40 )
