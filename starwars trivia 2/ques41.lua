...
level =   display.newText( "41/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What do Han and Luke ride in the snow on Hoth?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Tauntaum", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Tarkin", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Maunaut", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Tantam", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "taunt...",  w/2, h/4+100, "marker felt", 40 )
