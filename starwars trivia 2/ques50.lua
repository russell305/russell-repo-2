...
level =   display.newText( "50/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "At the very end, who does Luke see together?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Anakin, Ben, and Yoda", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "His Mother And Father", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Anakin, Owen, and Ben", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Yoda and Ben", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "aby...",  w/2, h/4+100, "marker felt", 40 )
