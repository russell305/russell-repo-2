...
level =   display.newText( "40/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What happened to the band of jawas that sold R2-D2 and C-3PO to Luke?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Thet Went To Mos Eisley", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "They Attacked Later On", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "They Were Killed By Stormtroopers", answer3.x, answer3.y, "marker felt", 45 )
...
answer4Text=display.newText( "None Of The Above", answer4.x, answer4.y, "marker felt", 50)
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "murder...",  w/2, h/4+60, "marker felt", 40 )
