...
level =   display.newText( "42/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "How do Ackbar and Lando try to neutralize the effectiveness of the Death Star?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Leaving The Area", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Attacking It Directly", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Ignoring It", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Moving In Among The Imperial Ships", answer4.x, answer4.y, "marker felt", 45 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "move slowly...",  w/2, h/4+100, "marker felt", 40 )
