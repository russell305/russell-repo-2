...
level =   display.newText( "18/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "On Tatooine, what ailment was C-3PO suffering from in the desert?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Lack Of Water", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Semifrozen Joints", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Lack Of Oil", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Rusty Bolts", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "cold...",  w/2, h/4+100, "marker felt", 40 )
