...
level =   display.newText( "14/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "After Luke discovers R2-D2 in the desert on Tatooine, he says 'Sandpeople, or worse.' What is 'or worse'?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Jawas", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Krayt Dragons", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Sand Dragons", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Bounty Hunters", answer4.x, answer4.y, "marker felt", 50 )
...
hintA = function (event )
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            myTextHints = display.newText( "kd...",  w/2, h/4+100, "marker felt", 40 )
