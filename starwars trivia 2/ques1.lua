...
level =   display.newText( "1/50",40,15, "marker felt", 30 )
...
local options1 = 
{
    text = "What part of Luke's body did Darth Vader sever?",
    x = w/2,
    y= h/6,
...
answer1Text=display.newText( "Leg", answer1.x, answer1.y, "marker felt", 50 )
...
answer2Text=display.newText( "Head", answer2.x, answer2.y, "marker felt", 50 )
...
answer3Text=display.newText( "Hand", answer3.x, answer3.y, "marker felt", 50 )
...
answer4Text=display.newText( "Ear", answer4.x, answer4.y, "marker felt", 50 )
        ...
        if  event.phase == "began" then
           ...
           storyboard.Hints=storyboard.Hints-1
            ...
            ------------------------------------------------------------------
                 ------------------------------------------------------------------
                      ------------------------------------------------------------------
            myTextHints = display.newText( "holds the lightsaber...",  w/2, h/4+100, "marker felt", 40 )
